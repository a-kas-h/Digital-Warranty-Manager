...
export const CONTRACT_ADDRESS = '0x5ea464A6E56f05Ba324882146764dB70d3Bd7f94'; 
...
export const isWarrantyValid = (warranty) => {
  return warranty.isValid && !warranty.hasExpired;
};